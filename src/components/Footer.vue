<template>
  <footer class="container-fluid py-5" style="background-color: #455a64">
    <div class="row">
      ...
      <div class="col-6 col-md">
        <h5 style="color: #52c769">Features</h5>
      ...
      <div class="col-6 col-md">
        <h5 style="color: #52c769">Resources</h5>
        <ul class="list-unstyled text-small">
      ...
      <div class="col-6 col-md">
        <h5 style="color: #52c769">About</h5>
        <ul class="list-unstyled text-small">
